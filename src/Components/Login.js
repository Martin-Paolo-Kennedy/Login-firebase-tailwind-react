        ...
        <div className='w-full max-w-xs m-auto'>
            ...
            <form onSubmit={handleSubmit} className='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <div className='mb-4'>
                    ...
                    <input type='password' className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder='******' name="password" id="password" onChange={handleChange}></input>
                </div>

                <div className="flex items-center justify-between">
                    <button className='bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:shadow-outline'>Login</button>
